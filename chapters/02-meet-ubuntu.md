...
Now that you know what a computer is, let's explore Ubuntu! 🎉 When you turn on your computer, Ubuntu is what makes everything work. Think of it as the captain 🧑‍✈️ of your computer ship 🚢 - it's in charge of everything!
...
- Click an icon to open that program 🖱️
...
2. Click the power icon 🔋 to see battery and settings ⚙️
...
- A **file** 📄 is one thing: a picture 🖼️, a document 📝, a song 🎵
- A **folder** 📁 holds multiple files (and other folders!) - it's like a box 📦 inside a box!
...
**Desktop:** 🖥️ Files you put on your desktop
**Documents:** 📚 Good for storing papers and reports
**Downloads:** ⬇️ Where files you download from the Internet go
...
3. Right-click in the empty space 🖱️
4. Choose "New Folder" ✨
...
Ubuntu comes with lots of useful programs already installed! 🎁 It's like getting a brand new computer that already has all the good stuff on it! Let's meet the most important ones:
...
We just used this! It helps you organize all your stuff 🗂️. Think of it as your digital backpack organizer! 🎒
...
- **Calc:** 📊 For spreadsheets (like Excel - perfect for tracking your allowance! 💵)
...
Every file has a few important properties (like a character in a video game has stats! 🎮):

**Name:** 🏷️ What the file is called (like "vacation-photo.jpg")

**Type:** 🎭 What kind of file it is:
- `.txt` = Text file 📝
- `.jpg` or `.png` = Picture 🖼️
- `.mp3` = Music 🎵
- `.mp4` = Video 🎬
...
Let's look at a file's properties (detective work time!):

1. Open Files 📂
2. Click on "Documents" 📚
3. Right-click on any file 🖱️ (or create a new folder if it's empty)
4. Choose "Properties" 📋
5. See the file's size 📏, type 🎭, and when it was created! 📅 You're like a file inspector now! 🔍
...
- Grab here to drag the window around 👋 (like moving furniture!)

**Three Buttons (Top Right):** 🔘🔘🔘
- **Minimize (-):** 📦 Hide window temporarily (it goes to the top bar - like putting a toy away!)
- **Maximize (□):** 🔲 Make window fill the whole screen (MAXIMIZE POWER! ⚡)
- **Close (X):** ❌ Quit the program (bye bye! 👋)

**Try This!** 🎮

Let's practice with windows (window ninja training! 🥷):

1. Open the Calculator 🧮 (type "calc" in Applications)
2. Drag the window around by its title bar 👆 (wheee! 🎢)
...
**Pro Tip:** 💡 You can also right-click on the title bar for more options! Secret menu unlocked! 🔓
...
- **Suspend:** 😴 Computer goes to sleep (uses almost no power, but you can wake it up fast - like a quick nap!)
- **Restart:** 🔄 Turn off and turn back on (good when updating - like a fresh start!)
- **Power Off:** 🛑 Shut down completely (goodnight, computer! 🌙)

**Important:** ⚠️ Always use the power menu to shut down. Don't just hold the power button unless the computer is frozen! That's like unplugging something without asking nicely first - not cool! 😅
...
- File types are shown by their extension (`.jpg` 🖼️, `.txt` 📝, etc.)
- Always shut down properly using the power menu 🔌 (be nice to your computer! 💚)
...
**What's Next:** 🚀 You've got the basics down! You're officially an Ubuntu navigator! 🧭 In Chapter 3, we're going to explore the Internet 🌍. You'll learn how to browse the web 🌐, stay safe online 🛡️, and use email 📧. Get ready to connect with the whole world! 🌎
